...
(echo "^fg($highlight)Artist Info "; echo "^fg($highlight)BIOGRAPHY"; echo " "; echo "$bio";  echo " "; sleep 15) | dzen2 -fg $foreground -bg $background -fn $FONT -x $XPOS -y $YPOS -w $WIDTH -l $LINES -e 'onstart=uncollapse,hide;button1=exit;button3=exit'
